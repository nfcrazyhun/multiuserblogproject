<div
    ...
    x-init="new Pikaday({ field: $refs.input, format: 'YYYY-MM-DD', onOpen() { this.setDate($refs.input.value) } })"
...
>
    ...
    <input
        ...
        x-ref="input"
        x-bind:value="value"
        class="rounded-none rounded-r-md flex-1 form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5 p-2"
    />
</div>
